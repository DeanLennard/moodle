...
class sqlite3_db_dataplus extends sqlite3_db {
    ...
    public function get_field_types(){
    	...
    	return array('smalltext' => get_string('field_smalltext', 'dataplus'),
	...
	public function list_dataplus_table_columns($include_supporting = false, $parameters = array()){
		...
		if(!$include_supporting){
			...
			for($i=0; $i<$end; $i++){
				if(in_array($columns[$i]->name,$supporting_cols) || substr($columns[$i]->name,$supp_suffix_len) == $this->get_supporting_suffix()){
					unset($columns[$i]);
				}
			}
		}
   ...
   /**
    ...
    public function get_comment($id, $additional_parameters = null){
        ...
        $columns = array('id','comment','group_id','creator','creator_id','created_time','last_update','last_update_id','last_update_time');
