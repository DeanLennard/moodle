...
//
//Backs up the dataplus table data and the structure of the database as well as, optionally,
//user data.
...
function backup_dataplus_files_instance ($bf, $preferences, $instanceid, $dbonly = false) {
    ...
    $temp_dir = $CFG->dataroot."/temp/backup/".$preferences->backup_unique_code.
        "/moddata/dataplus/";
    $data_dir = $CFG->dataroot."/".$preferences->backup_course."/".$CFG->moddata."/dataplus/".
        $instanceid;
...
function dataplus_check_backup_mods($course, $user_data = false, $backup_unique_code = null,
    $instances = null) {
